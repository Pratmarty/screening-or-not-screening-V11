...
MODEL_PATH = "rf_risque_blessure_model.joblib"
if not os.path.exists(MODEL_PATH):
    st.error("Modèle non trouvé. Assurez-vous que 'rf_risque_blessure_model.joblib' est dans le même dossier que app.py.")
    st.stop()
